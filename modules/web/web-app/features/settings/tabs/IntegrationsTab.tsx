import { Button, Card, CardContent, ScrollArea } from '@ui/components'
import { cn } from '@ui/lib'
import { CheckCircle, CreditCard, PlugIcon } from 'lucide-react'
...
export const IntegrationsTab = () => {
  ...
  const sections: Section[] = [
    ...
    //       features: ['Lead management', 'Analytics'],
    //     },
    //     {
    //       name: 'HubSpot',
    //       description: 'Marketing & sales platform',
    //       features: ['Marketing automation', 'CMS'],
    //     },
    //   ],
    // },
  ]
  ...
  return (
    <div className="mx-auto flex">
      ...
      {/* Table of Contents */}
      <div className="w-64 border-l flex-none">
        <div className="p-6">
