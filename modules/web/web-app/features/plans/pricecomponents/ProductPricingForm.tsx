...
import { PricingFields, type DimensionCombination } from '@/features/pricing/PricingFields'
import {
...
function useMatrixDimensions(billableMetric: BillableMetric | undefined): {
