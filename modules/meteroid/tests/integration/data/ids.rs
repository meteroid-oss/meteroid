...
// Enterprise (no components, used as trialing_plan target)
...
// Free with Trial (7d, trialing → Enterprise)
...
// Paid with Free Trial (14d free trial, Rate 49/mo)
...
// Paid with Paid Trial (7d paid trial, Rate 99/mo)
...
// Pro (Platform Fee + Seats, with draft v2)
...
// USD (no components, for currency mismatch test)
