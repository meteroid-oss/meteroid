...
--
    ...
    (id, name, created_at, created_by, updated_at, updated_by, archived_at, tenant_id,
     alias, billing_email, invoicing_emails, phone, balance_value_cents, currency,
     billing_address, shipping_address, invoicing_entity_id)
    VALUES (var_cust_spotify_id, 'Sportify', '2023-12-04 10:28:39.845',
            var_user_id, NULL, NULL, NULL, var_tenant_id, 'spotify', NULL, '{}', NULL, 0, 'EUR', NULL, NULL,
            var_invoicing_entity_id),
           (var_cust_uber_id, 'Uber', '2023-12-04 10:29:07.699',
            var_user_id, NULL, NULL, NULL, var_tenant_id, 'uber', NULL, '{}', NULL, 0, 'EUR', NULL, NULL,
            var_invoicing_entity_id),
           (var_cust_comodo_id, 'Comodo', '2023-12-04 10:32:34.036',
            var_user_id, NULL, NULL, NULL, var_tenant_id, 'comodo', NULL, '{}', NULL, 0, 'EUR', NULL, NULL,
            var_invoicing_entity_id);
