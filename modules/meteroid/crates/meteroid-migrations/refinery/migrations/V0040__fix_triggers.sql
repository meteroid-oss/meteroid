alter table bi_revenue_daily drop constraint "bi_revenue_daily_pkey";
alter table bi_revenue_daily alter column plan_version_id drop not null;
alter table bi_revenue_daily add column "id" uuid not null primary key default gen_random_uuid();
