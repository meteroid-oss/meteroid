...
use diesel::{ExpressionMethods, OptionalExtension, debug_query, RunQueryDsl};
...
impl HistoricalRatesFromUsdRowNew {
    ...
    pub async fn insert_batch(conn: &mut PgConn, values: Vec<HistoricalRatesFromUsdRowNew>) -> DbResult<()> {
        use crate::schema::historical_rates_from_usd::dsl as r_dsl;
        use diesel_async::RunQueryDsl;
