...
use diesel::{debug_query, ExpressionMethods, QueryDsl, SelectableHelper, JoinOnDsl};
use error_stack::ResultExt;

impl InvoicingEntityRow {
    pub async fn list_by_ids(conn: &mut PgConn, ids: Vec<uuid::Uuid>) -> DbResult<Vec<InvoicingEntityRow>> {
    ...
    pub async fn exists_any_for_tenant(conn: &mut PgConn, tenant_id: &uuid::Uuid) -> DbResult<bool> {
        use diesel_async::RunQueryDsl;
        use crate::schema::invoicing_entity::dsl as dsl;

        let query = diesel::dsl::select(diesel::dsl::exists(dsl::invoicing_entity.filter(dsl::tenant_id.eq(tenant_id))));
    ...
    pub async fn is_in_use(conn: &mut PgConn, invoicing_entity_id: &uuid::Uuid, tenant_id: &uuid::Uuid) -> DbResult<bool> {
        use diesel_async::RunQueryDsl;
        use crate::schema::invoice::dsl as i_dsl;
        use crate::schema::customer::dsl as c_dsl;

        let query = diesel::dsl::select(diesel::dsl::exists(i_dsl::invoice
    ...
    pub async fn get_invoicing_entity_by_id_and_tenant(conn: &mut PgConn, id: &uuid::Uuid, tenant_id: &uuid::Uuid) -> DbResult<InvoicingEntityRow> {
        use diesel_async::RunQueryDsl;
        use crate::schema::invoicing_entity::dsl as dsl;
    ...
    pub async fn select_for_update_by_id_and_tenant(conn: &mut PgConn, id: &uuid::Uuid, tenant_id: &uuid::Uuid) -> DbResult<InvoicingEntityRow> {
        use diesel_async::RunQueryDsl;
        use crate::schema::invoicing_entity::dsl as dsl;
    ...
    pub async fn update_invoicing_entity_number(conn: &mut PgConn, id: &uuid::Uuid, tenant_id: &uuid::Uuid, new_invoice_number: i64) -> DbResult<InvoicingEntityRow> {
        use diesel_async::RunQueryDsl;
        use crate::schema::invoicing_entity::dsl as dsl;
...
impl InvoicingEntityRowPatch {
    pub async fn patch_invoicing_entity(&self, conn: &mut PgConn, tenant_id: &uuid::Uuid) -> DbResult<InvoicingEntityRow> {
        use diesel_async::RunQueryDsl;
        use crate::schema::invoicing_entity::dsl as dsl;
