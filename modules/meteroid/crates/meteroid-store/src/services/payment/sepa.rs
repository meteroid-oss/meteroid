...
pub const SEPA_COUNTRIES: [rust_iso3166::CountryCode; 41] = [
    ...
    rust_iso3166::VA, // Vatican City
    rust_iso3166::MK, // North Macedonia
    rust_iso3166::MD, // Moldova
    rust_iso3166::MC, // Monaco
    rust_iso3166::ME, // Montenegro
    rust_iso3166::GB, // United Kingdom
    rust_iso3166::SM, // San Marino
    rust_iso3166::RS, // Serbia
    rust_iso3166::CH, // Switzerland
];
