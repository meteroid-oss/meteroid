...
use meteroid_grpc::meteroid::api::invoicingentities::v1::{CreateInvoicingEntityRequest, CreateInvoicingEntityResponse, invoicing_entities_service_server::InvoicingEntitiesService, ListInvoicingEntitiesRequest, ListInvoicingEntitiesResponse, UpdateInvoicingEntityRequest, UpdateInvoicingEntityResponse};
...
impl InvoicingEntitiesService for InvoicingEntitiesServiceComponents {
    ...
    async fn list_invoicing_entities(&self, request: Request<ListInvoicingEntitiesRequest>) -> Result<Response<ListInvoicingEntitiesResponse>, Status> {
    ...
    async fn create_invoicing_entity(&self, request: Request<CreateInvoicingEntityRequest>) -> Result<Response<CreateInvoicingEntityResponse>, Status> {
        let tenant = request.tenant()?;
        ...
        let res = self.store.create_invoicing_entity(
    ...
    async fn update_invoicing_entity(&self, request: Request<UpdateInvoicingEntityRequest>) -> Result<Response<UpdateInvoicingEntityResponse>, Status> {
        let tenant = request.tenant()?;
        ...
        let res = self.store.patch_invoicing_entity(
