...
use meteroid_grpc::meteroid::api::subscriptions::v1_2::subscription_service_server::SubscriptionServiceServer;
...
) -> SubscriptionServiceServer<SubscriptionServiceComponents> {
    let inner = SubscriptionServiceComponents {
        store,
        compute_service: subscription_billing,
        eventbus,
    };
    SubscriptionServiceServer::new(inner)
}
