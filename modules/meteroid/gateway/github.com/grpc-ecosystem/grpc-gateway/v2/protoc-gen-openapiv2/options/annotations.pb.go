...
var file_protoc_gen_openapiv2_options_annotations_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x32, 0x54, 0x61, 0x67, 0x42, 0xc9, 0x02, 0x0a, 0x2d,
...
var file_protoc_gen_openapiv2_options_annotations_proto_goTypes = []interface{}{
	...
	(*Swagger)(nil),                     // 4: grpc.gateway.protoc_gen_openapiv2.options.Swagger
	(*Operation)(nil),                   // 5: grpc.gateway.protoc_gen_openapiv2.options.Operation
	(*Schema)(nil),                      // 6: grpc.gateway.protoc_gen_openapiv2.options.Schema
	(*Tag)(nil),                         // 7: grpc.gateway.protoc_gen_openapiv2.options.Tag
}
var file_protoc_gen_openapiv2_options_annotations_proto_depIdxs = []int32{
	...
	4, // 4: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_swagger:type_name -> grpc.gateway.protoc_gen_openapiv2.options.Swagger
	5, // 5: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_operation:type_name -> grpc.gateway.protoc_gen_openapiv2.options.Operation
	6, // 6: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_schema:type_name -> grpc.gateway.protoc_gen_openapiv2.options.Schema
	7, // 7: grpc.gateway.protoc_gen_openapiv2.options.openapiv2_tag:type_name -> grpc.gateway.protoc_gen_openapiv2.options.Tag
